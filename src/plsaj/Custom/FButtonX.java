 ...
 * @author FOSALGO
 */
public class FButtonX extends JButton {
    ...
    public FButtonX() {
        fillOriginal = new Color(43,124,99);
        fillOver = new Color(228, 228, 228);
        fillClick = new Color(200, 200, 200);
        lineOriginal = new Color(240,240,240);
        lineOver = new Color(43,124,99);
        strokeWidth = 2;
